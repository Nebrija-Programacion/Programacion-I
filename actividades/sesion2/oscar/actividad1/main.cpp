...
int main()
{
    ...
    cout << "El area de su triangulo deseado es = " << miTriangulo.areaTriangulo(base, altura) << endl;
    ...
    cout << "El area de su rectangulo es = " <<  miRectangulo.areaRectangulo(lado1, lado2)
         << " y su perimetro es = " <<  miRectangulo.perimetroRectangulo(lado1, lado2) << endl;
