...
float productoScalar(Vector a, Vector b){
    float result{0};
    if (a.getSize() != b.getSize()){
        throw string{"No puedo calcular el producto escalar"};
    }
    for (int i=0; i<a.getSize(); i++){
...
{   
    ...
    cout << productoScalar(miVector,miVector2) << endl;
    ...
    cout << "El angulo entre los dos vectores en radianes es: " << anguloEnRadianes(miVector,miVector2) << endl;
