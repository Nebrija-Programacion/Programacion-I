...
Vector add(Vector a, Vector b)
{
    Vector suma(a.getSize());
     if(a.getSize() != b.getSize()) throw string{"No se puede sumar"};
...
cout << "El angulo formado entre los vectores es de: " << anguloRadianes(Vector1, Vector3) <<  " radianes" << endl;
