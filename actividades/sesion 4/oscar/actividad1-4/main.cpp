...
int main(){
    ...
    cout << "Cual es el valor para x en vector 1: " << endl;
    cin >> x;
    cout << "Cual es el valor para y en vector 1: " << endl;
    cin >> y;
    cout << "Cual es el valor z en vector 1: " << endl;
    cin >> z;
    ...
    cout << "Cual es el valor para para x en vector 2: " << endl;
    cin >> x;
    cout << "Cual es el valor para para y en vector 2: " << endl;
    cin >> y;
    cout << "Cual es el valor para para z en vector 2: " << endl;
    cin >> z;
    ...
    cout << "Cual es el valor para para x en vector 3: " << endl;
    cin >> x;
    cout << "Cual es el valor para para y en vector 3: " << endl;
    cin >> y;
    cout << "Cual es el valor para para z en vector 3: " << endl;
    cin >> z;
